async function getrequestsAPI() {
  const response = await fetch(
    "http://localhost/Implement%20Facebook-Ali%20Daana/php/getFriendRequest.php",
    {
      method: "POST",
    }
  );
...
async function acceptAPI(id) {
  const response = await fetch(
    "http://localhost/Implement%20Facebook-Ali%20Daana/php/acceptFriend.php",
    {
      method: "POST",
...
async function rejectAPI(id) {
  const response = await fetch(
    "http://localhost/Implement%20Facebook-Ali%20Daana/php/declineFriend.php",
    {
      method: "POST",
      body: new URLSearchParams({
        user_from: id,
